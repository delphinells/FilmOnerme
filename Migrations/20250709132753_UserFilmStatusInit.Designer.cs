...
namespace FilmOnerme.Migrations
{
    ...
    [Migration("20250709132753_UserFilmStatusInit")]
    partial class UserFilmStatusInit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmOnerme.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FilmOnerme.Models.UserFilmStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FilmOnerme.Models.UserProfile", b =>
                {
                    ...
                    b.Property<string>("FavoriteDirector")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("WatchingFrequency")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FilmOnerme.Models.UserProfile", b =>
                {
                    b.HasOne("FilmOnerme.Models.ApplicationUser", "User")
                        .WithOne("Profile")
                        .HasForeignKey("FilmOnerme.Models.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FilmOnerme.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
